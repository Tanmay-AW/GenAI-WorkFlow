...
// FIX: Correct the type definition for NodeProps. The generic type should be the data type itself, not an object wrapping it. This makes `data.outputText` accessible.
    ...
    return (
        <CustomNodeWrapper title="Output" icon={<OutputIcon />} hasOutput={false}>
            <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600 p-2 bg-gray-100 rounded-md min-h-[60px]">
                    {data.outputText}
                </p>
            </div>
        </CustomNodeWrapper>
